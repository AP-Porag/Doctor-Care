    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="{{route('role.index')}}" class="btn btn-sm btn-outline-success text-capitalize"><i class="fa fa-handshake mr-1"></i>Active @yield('module')</a>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable table-striped table-hover" id="dataTable" width="100%" cellspacing="0"
                                ...
                                @foreach($trashed_roles as $key=>$role)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="btn-group d-flex justify-content-center">
                                                <a href="{{route('restore_role',$role->id)}}" class="btn btn-sm btn-outline-success mr-3"><i class="fab fa-creative-commons-share"></i></a>
                                                <a href="{{route('forceDelete_role',$role->id)}}" class="btn btn-sm btn-outline-danger mr-3"><i class="fas fa-window-close"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach

...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <a href="{{route('company.create')}}" class="btn btn-sm btn-outline-primary text-capitalize"><i
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                       placeholder="Enter Company name" value="{{$company->name,old('name')}}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone"
                                       placeholder="Enter Company phone" value="{{$company->phone,old('phone')}}">
                                @error('phone')
                                <div class="alert alert-danger alert-dismissible fade show mt-1">
                                    <strong>Warning! </strong>{{$message}}
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sr_name" class="form-control" id="sr_name"
                                       placeholder="Enter Company representative Name" value="{{$company->sr_name,old('sr_name')}}">
                                @error('sr_name')
                                <div class="alert alert-danger alert-dismissible fade show mt-1">
                                    <strong>Warning! </strong>{{$message}}
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="img-thumbnail">
                                            <img :src="image" alt="{{$company->name}}" class="img-fluid">
                                        </div>
                                    </div>
